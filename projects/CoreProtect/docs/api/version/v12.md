...
Build and install the TFMC CoreProtect source. Its Maven coordinates are `net.coreprotect:CoreProtect`; the Java API package is `net.tfminecraft.coreprotect`.
