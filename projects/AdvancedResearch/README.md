...
**Temporarily reopened:** The verified Java 21 / Minecraft 1.21.10 migration is pushed in [PR #4](https://github.com/TF-Minecraft/AdvancedResearch/pull/4) and awaits the required independent review. Restore the repository’s archived state after the migration is merged; it has not been deployed.
