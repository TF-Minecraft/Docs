...
Published Java 21 replacement: [1.0.1](https://github.com/TF-Minecraft/VFBuilders/releases/tag/v1.0.1), verified locally. See the [replacement release status](../../PLATFORM.md#java-21-dependency-replacements) for provenance, verification and deployment status.
