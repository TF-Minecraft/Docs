...
Published Java 21 replacement: [0.0.3](https://github.com/TF-Minecraft/MarketBlock/releases/tag/v0.0.3), verified locally. See the [replacement release status](../../PLATFORM.md#java-21-dependency-replacements) for provenance, verification and source-review boundaries.
