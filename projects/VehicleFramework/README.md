...
Published Java 21 replacement: [1.1.13](https://github.com/TF-Minecraft/VehicleFramework/releases/tag/v1.1.13), verified locally. See the [replacement release status](../../PLATFORM.md#java-21-dependency-replacements) for provenance, verification and source-review boundaries.
