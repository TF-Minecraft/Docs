...
War gameplay and export schema live in SimpleFactions: see [`../../simplefactions/docs/wars.md`](https://github.com/TF-Minecraft/SimpleFactions/blob/main/docs/wars.md).
